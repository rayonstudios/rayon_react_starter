...
export interface components {
  schemas: {
    ...
    APIResponse_PaginationSortResponse_SanitizedUser__: {
      data:
        | components["schemas"]["PaginationSortResponse_SanitizedUser_"]
        | null;
      error: string | null;
    };
    /** @enum {string} */
    ...
    "Expand_Omit_NotificationMutable.event_-and-_roles_63_-Role-Array--userIds_63_-string-Array--metadata_63_-GenericObject__": {
      ...
      link?: string;
      metadata?: ((
        | components["schemas"]["Prisma.NullableJsonNullValueInput"]
        | components["schemas"]["InputJsonValue"]
      ) &
    ...
    APIResponse_PaginationSortResponse_Notification__: {
      data:
        | components["schemas"]["PaginationSortResponse_Notification_"]
        | null;
      error: string | null;
    };
    /** @enum {string} */
    ...
    "Expand_BgJobData-and-_taskId-string--taskMetadata-GenericObject__":
      ...
      | {
          ...
          /** Format: date-time */
          scheduledFor?: Date;
          job: components["schemas"]["BgJobType.DEMO_JOB"];
          payload: {
            /** Format: double */
  ...
  CreateDemoJob: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["APIResponse__taskId-string__"];
        };
      };
    };
  };
